...
public class Pantalla_Checador {
	...
	public JPanel panel_checado, panel_negro;
	...
	public JPanel getPanel() {
		...
		panel_checado = new JPanel();
		panel_checado.setBackground(Color.lightGray);
		panel_checado.setLayout(null);
		
		text_inicio = new JLabel("CHECADOR");
		text_inicio.setFont(new Font("Arial", Font.BOLD, 32));
		text_inicio.setBounds(255, 20, 290, 50);
		panel_checado.add(text_inicio);
        ...
        btn_entrar.setFocusPainted(false);
        btn_entrar.addActionListener(e -> {
        	checador.pintar_vista(new Pantalla_Usuarios(checador).getPanel());
        });
        panel_negro.add(btn_entrar);
        ...
        btn_entrar.setFocusPainted(false);
        btn_entrar.addActionListener(e -> {
        	checador.pintar_vista(new Pantalla_Instructores(checador).getPanel());
        });
        panel_negro.add(btn_entrar);
        ...
        btn_entrar.setFocusPainted(false);
        btn_entrar.addActionListener(e -> {
        	checador.pintar_vista(new Pantalla_Planes(checador).getPanel());
        });
        panel_negro.add(btn_entrar);
        ...
        btn_entrar.setFocusPainted(false);
        btn_entrar.addActionListener(e -> {
        	checador.pintar_vista(new Pantalla_Checador(checador).getPanel());
        });
        panel_negro.add(btn_entrar);
        ...
        btn_entrar.setFocusPainted(false);
        btn_entrar.addActionListener(e -> {
        	checador.pintar_vista(new View_loginGYM(checador).getPanel());
        });
        panel_negro.add(btn_entrar);
		...
		panel_checado.add(confi);
		
		return panel_checado;
	}
}
